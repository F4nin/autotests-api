...
from clients.exercises.exercises_schema import ExerciseSchema, GetExercisesRequestSchema, CreateExercisesRequestSchema, \
    UpdateExercisesRequestSchema, GetExerciseResponseSchema, GetExercisesResponseSchema, CreateExerciseResponseSchema, \
