...
def assert_get_courses_response(
    ...
    """
    assert_lenght(get_courses_response.courses, create_courses_responses, "course")
...
def assert_create_course_response(request:CreateCourseRequestSchema, response:CreateCourseResponseSchema):
    ...
    assert_equal(response.course.created_by_user.id, request.created_by_user_id, "preview_file_id")
