...
from clients.authentication.authentication_schema import LoginRequestSchema, LoginResponseSchema, RefreshResponseSchema, \
...
class TestAuthentication:
    ...
    @allure.title("Refresh token with correct credentials")
    @allure.severity(Severity.NORMAL)
    def test_refresh_token(self, function_authentication: AuthenticationFixture, authentication_client: AuthenticationClient):
        ...
        assert_refresh_token_response(response_data)
